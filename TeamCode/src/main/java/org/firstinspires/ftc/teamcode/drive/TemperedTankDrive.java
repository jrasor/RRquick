...
public class TemperedTankDrive extends TankDrive {
    ...
    public TemperedTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "motor0");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "motor1");
