...
/*
 * Simple front wheel drive hardware implementation for REV hardware. Game pad
 * commands are like the Sample Tank Drive class.
 */
@Config
public class FrontWheelDrive extends TankDrive {
    ...
    public FrontWheelDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "motor0");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "motor1");
